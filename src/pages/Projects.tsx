...
const Projects = () => {
    ...
    const projects = [
        ...
        { id: 4, title: "Fake Store", description: "A fake store built with HTML, CSS, and JavaScript. It also includes a minimal configuration for state management, routing, and managing products in a shopping cart.", link: "https://github.com/Four26/shopping-cart-odin.git", image: image.fakeStore },
        { id: 5, title: "Memory Game", description: "A simple memory pokemon card game built with ReactVite.", link: "https://github.com/Four26/memory-game.git", image: image.memoryGame },
        ...
        { id: 7, title: "Palindrome Checker", description: "A palindrome checker built HTML, CSS and JavaScript.", link: "https://github.com/Four26/Palindrome-Checker.git", image: image.palindromeChecker },
